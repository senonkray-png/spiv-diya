...
const navItems: NavItem[] = [
  ...
  { href: "/dashboard/orders", label: "Замовлення", icon: ReceiptIcon },
    ...
    <>
      ...
      <aside className="hidden md:flex w-64 shrink-0 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex-col min-h-screen">
        <div className="px-6 py-5 border-b border-zinc-200 dark:border-zinc-800">
          <Link href="/marketplace" className="text-lg font-bold text-zinc-900 dark:text-white">
            СпівДія
          </Link>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between px-4 h-14 gap-2">
        <Link href="/marketplace" className="font-bold text-zinc-900 dark:text-white shrink-0">СпівДія</Link>
