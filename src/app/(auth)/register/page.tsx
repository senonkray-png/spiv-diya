    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-zinc-950 dark:to-zinc-900 px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/marketplace" className="text-3xl font-bold text-zinc-900 dark:text-white">
            СпівДія
          </Link>
          ...
          <p className="mt-3 text-sm text-zinc-500 dark:text-zinc-400 max-w-sm mx-auto leading-relaxed">
            Після реєстрації ви одразу зможете увійти й користуватись маркетплейсом. (Підтвердження пошти листом зараз
            вимкнено на сервері — його можна знов увімкнути через змінні середовища.)
          </p>
        </div>
